...
int main() {
    ...
    // Test 1: Disabled level overhead
    {
        ...
        log.info("Disabled level test completed",
    ...
    // Test 2: Simple message logging
    {
        ...
        log.info("Simple message test completed",
                 field("iterations", iterations / 100),
                 field("total_time_us", bench.elapsed_us()),
    ...
    // Test 3: Message with fields
    {
        ...
        log.info("Fields test completed",
                 field("iterations", iterations / 100),
                 field("total_time_us", bench.elapsed_us()),
                 field("avg_time_ns", bench.elapsed_ns() / (iterations / 100)));
    }
    ...
    // Test 4: Logger creation and scoping
    {
        ...
        for (int i = 0; i < iterations / 100; ++i) {
            auto scoped_log = log.with_name("scoped")
                                 .with_field("iteration", i);
            scoped_log.info("Scoped message");
        }
        
        log.info("Logger scoping test completed",
                 field("iterations", iterations / 100),
                 field("total_time_us", bench.elapsed_us()),
                 field("avg_time_ns", bench.elapsed_ns() / (iterations / 100)));
    }
    ...
    // Test 5: Printf vs structured logging comparison
    {
        ...
        log.info("Printf vs structured comparison",
    ...
    // Test 6: Memory allocation patterns
    {
        ...
        log.info("Memory allocation test completed",
                 field("iterations", iterations / 1000),
                 field("total_time_us", bench.elapsed_us()),
                 field("avg_time_ns", bench.elapsed_ns() / (iterations / 1000)));
    }
